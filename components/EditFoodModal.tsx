...
const EditFoodModal: React.FC<EditFoodModalProps> = ({
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 backdrop-blur-sm p-4">
            <div className={`${isManagerMode ? 'bg-white text-slate-800 border-blue-200 shadow-2xl' : 'bg-white text-gray-900'} rounded-lg shadow-xl w-full max-w-md p-6`}>
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <input
                            ...
                            className={`w-full p-2 border rounded text-sm font-medium ${isManagerMode ? 'bg-white border-blue-300 text-slate-800' : 'bg-white border-emerald-300 focus:ring-2 focus:ring-emerald-500'}`}
                        />
                    ...
                    {preview && (
                        <div className={`p-4 rounded-lg ${isManagerMode ? 'bg-blue-50 border-blue-200' : 'bg-slate-50 border-slate-200'} border`}>
                ...
                <div className="mt-6 pt-4 border-t flex justify-end gap-3">
                    <button onClick={onClose} className={`px-4 py-2 text-sm border rounded ${isManagerMode ? 'border-blue-200 hover:bg-blue-50 text-blue-700' : ''}`}>Cancelar</button>
