                    ...
                    <div className="flex justify-end mb-4">
                        {isEditingTab ? (
                            ...
                            <div className="flex gap-2">
                                ...
                                <button onClick={() => { if (patient) setFormData(patient); setIsEditingTab(true); }} className={`px-4 py-2 text-sm flex items-center rounded border gap-1 font-bold ${isManagerMode ? 'bg-gray-700 border-gray-600 text-indigo-300 hover:bg-gray-600' : 'bg-white border-emerald-200 text-emerald-700 hover:bg-emerald-50'}`}>
